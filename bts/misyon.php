...
$sorgu = $baglanti->query("SELECT * FROM sayfalar where sayfaAdi='misyon'  "); // sayfalar tablosundaki tüm verileri çekiyoruz.
...
.kullanicim{
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <main role="main" class="container">
      <h3 class="mt-5 text-center">Misyon & Vizyon</h3>
      <center><p class="lead text-center"><?php echo $icerik ; ?></p></center>
